    ...
    <table class="table table-bordered mx-auto" style="max-width:700px;">
      ...
      <tbody>
        <tr>
          ...
          <td><?php if (intval($data['eer']) >= 92 && intval($data['eer']) <= 100) {
                echo $data['eer'];
              } ?></td>
          <td><?php if (intval($data['potential']) >= 92 && intval($data['potential']) <= 100) {
                echo $data['potential'];
              } ?></td>
        </tr>
        <tr>
          ...
          <td><?php if (intval($data['eer']) >= 81 && intval($data['eer']) <= 91) {
                echo $data['eer'];
              } ?></td>
          <td><?php if (intval($data['potential']) >= 81 && intval($data['potential']) <= 91) {
                echo $data['potential'];
              } ?></td>
        </tr>
        <tr>
          ...
          <td><?php if (intval($data['eer']) >= 69 && intval($data['eer']) <= 80) {
                echo $data['eer'];
              } ?></td>
          <td><?php if (intval($data['potential']) >= 69 && intval($data['potential']) <= 80) {
                echo $data['potential'];
              } ?></td>
        </tr>
        <tr>
          ...
          <td><?php if (intval($data['eer']) >= 55 && intval($data['eer']) <= 68) {
                echo $data['eer'];
              } ?></td>
          <td><?php if (intval($data['potential']) >= 55 && intval($data['potential']) <= 68) {
                echo $data['potential'];
              } ?></td>
        </tr>
        ...
        <tr>
          ...
          <td><?php if (intval($data['eer']) >= 39 && intval($data['eer']) <= 54) {
                echo $data['eer'];
              } ?></td>
          <td><?php if (intval($data['potential']) >= 39 && intval($data['potential']) <= 54) {
                echo $data['potential'];
              } ?></td>
        </tr>
        <tr>
          ...
          <td><?php if (intval($data['eer']) >= 21 && intval($data['eer']) <= 38) {
                echo $data['eer'];
              } ?></td>
          <td><?php if (intval($data['potential']) >= 21 && intval($data['potential']) <= 38) {
                echo $data['potential'];
              } ?></td>
        </tr>
        ...
        <tr>
          ...
          <td><?php if (intval($data['eer']) >= 1 && intval($data['eer']) <= 20) {
                echo $data['eer'];
              } ?></td>
          <td><?php if (intval($data['potential']) >= 1 && intval($data['potential']) <= 20) {
                echo $data['potential'];
              } ?></td>
        </tr>
